...
| PT Sans | Raleway |
| Manrope | Rubik |
| TeX Gyre Heros | Nimbus San L |
| Arvo | Michroma |
| Oswald | League Gothic |
| Asap | Cantarell |
| Cormorant SC | Source Serif 4 |
| Alegreya | Cormorant |
| Outfit | Spectral |
| Poppins | Josefin Slab |
| Ubuntu | Cabin |
| Satisfy | League Spartan |
| Barlow | RedHat Display |
| Lato | Montserrat |
...
| Barlow Condensed | Playfair Display |
| Quicksand | Questrial |
| Lora | Crimson Text |
| Cormorant Garamond | Pacifico |
| Roboto Slab | Aleo |
| Vollkorn | Anton |
| Luckiest Guy | Abril Fatface |
